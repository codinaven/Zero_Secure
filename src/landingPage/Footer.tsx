    ...
    <div>
      ...
      <footer className="mt-auto w-full max-w-340 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
          ...
          <div>
            <h3 className="text-xs font-semibold text-gray-800 uppercase">
              Product
            </h3>
          ...
          <div>
            ...
            <h3 className="mt-7 text-xs font-semibold text-gray-800 uppercase">
              Industries
            </h3>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="hs-dropdown [--placement:top-left] relative inline-flex">
                <button
                  ...
                  type="button"
                  className="hs-dropdown-toggle py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-lg bg-white border border-gray-200 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                  aria-haspopup="menu"
                  aria-expanded="false"
                  aria-label="Dropdown"
                >
                ...
                <div
                  className="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white border border-transparent shadow-md rounded-lg p-2"
                  role="menu"
