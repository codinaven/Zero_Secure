  ...
  return (
    <div>
        ...
        <div className="max-w-340 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="relative xl:w-10/12 xl:mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className="p-4 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10">
                  ...
                  <div className="mt-5 grid sm:grid-cols-2 gap-y-2 py-4 first:pt-0 last:pb-0 sm:gap-x-6 sm:gap-y-0">
                    ...
                    <ul className="space-y-2 text-sm sm:text-base">
                      <li className="flex gap-x-3">
                        ...
                        <span className="text-gray-800">Up to 10 people</span>
                      </li>
                      ...
                      <li className="flex gap-x-3">
                        ...
                        <span className="text-gray-800">Collect data</span>
                      </li>
                    ...
                    <ul className="space-y-2 text-sm sm:text-base">
                      <li className="flex gap-x-3">
                        <span className="size-5 flex justify-center items-center rounded-full bg-gray-100 text-gray-800">
                          <svg
                            className="shrink-0 size-3.5"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                        ...
                        <span className="text-gray-800">Custom reports</span>
                      </li>
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div className="flex justify-end">
                      <button
                        type="button"
                        className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-white border border-gray-200 text-gray-800 shadow-2xs hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-50"
                      >
                        Start free trial
                      </button>
                    </div>
              ...
              <div>
                {/* Card */}
                <div className="shadow-xl p-5 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10">
                  <h3 className="text-xl font-bold text-gray-800">Teams</h3>
                  <div className="text-sm text-gray-500">
                    For growing businesses.
                  </div>
                  <span className="absolute top-0 inset-e-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-gray-900 text-white py-1.5 px-3">
                    Most popular
                  </span>
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div className="flex justify-end">
                      <button
                        type="button"
                        className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-blue-600 border border-transparent text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                      >
                        Start free trial
                      </button>
                    </div>
            ...
            {/* SVG Element */}
            <div className="hidden md:block absolute top-0 inset-e-0 translate-y-16 translate-x-16">
              <svg
            ...
            {/* SVG Element */}
            <div className="hidden md:block absolute bottom-0 inset-s-0 translate-y-16 -translate-x-16">
              <svg
      ...
      <div className="relative">
        <div className="max-w-340 px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
          ...
          {/* Header */}
          <div className="hidden lg:block sticky top-0 inset-s-0 py-2 bg-white/60 backdrop-blur-md">
            {/* Grid */}
